...
func (az *Provider) getStorageAccounts(ctx context.Context, accountOptions *AccountOptions) ([]accountWithLocation, error) {
...
func (az *Provider) GetStorageAccesskey(ctx context.Context, subsID, account, resourceGroup string, getLatestAccountKey bool) (string, error) {
	if az.StorageAccountClient == nil {
...
func (az *Provider) EnsureStorageAccount(ctx context.Context, accountOptions *AccountOptions, genAccountNamePrefix string) (string, string, error) {
	...
	if createNewAccount {
		...
		tags := util.ConvertMapToMapPointer(accountOptions.Tags)
...
func (az *Provider) createPrivateDNSZone(ctx context.Context, vnetResourceGroup, privateDNSZoneName string) error {
...
func (az *Provider) createVNetLink(ctx context.Context, vNetLinkName, vnetResourceGroup, vnetName, privateDNSZoneName string) error {
...
func (az *Provider) createPrivateDNSZoneGroup(ctx context.Context, dnsZoneGroupName, privateEndpointName, vnetResourceGroup, vnetName, privateDNSZoneName string) error {
...
func (az *Provider) getStorageAccountWithCache(ctx context.Context, subsID, resourceGroup, account string) (storage.Account, *retry.Error) {
	if az.StorageAccountClient == nil {
...
func (az *Provider) AddStorageAccountTags(ctx context.Context, subsID, resourceGroup, account string, tags map[string]*string) *retry.Error {
...
func (az *Provider) RemoveStorageAccountTag(ctx context.Context, subsID, resourceGroup, account, key string) *retry.Error {
	result, rerr := az.getStorageAccountWithCache(ctx, subsID, resourceGroup, account)
	if rerr != nil {
		return rerr
	}
...
func (az *Provider) isMultichannelEnabledEqual(ctx context.Context, account storage.Account, accountOptions *AccountOptions) bool {
	if accountOptions.IsMultichannelEnabled == nil {
		return true
	}
...
func (az *Provider) isDisableFileServiceDeleteRetentionPolicyEqual(ctx context.Context, account storage.Account, accountOptions *AccountOptions) bool {
	if accountOptions.DisableFileServiceDeleteRetentionPolicy == nil {
		return true
	}
...
func (az *Provider) isEnableBlobDataProtectionEqual(ctx context.Context, account storage.Account, accountOptions *AccountOptions) bool {
	if accountOptions.SoftDeleteBlobs == 0 &&
		accountOptions.SoftDeleteContainers == 0 &&
