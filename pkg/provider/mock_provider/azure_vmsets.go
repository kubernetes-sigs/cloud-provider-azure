...
// Source: pkg/provider/azure_vmsets.go
...
func (m *MockVMSet) AttachDisk(ctx context.Context, nodeName types.NodeName, diskMap map[string]*provider.AttachDiskOptions) (*azure.Future, error) {
	m.ctrl.T.Helper()
