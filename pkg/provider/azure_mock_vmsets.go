...
//
//	mockgen -source azure_vmsets.go -package provider -self_package sigs.k8s.io/cloud-provider-azure/pkg/provider -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
