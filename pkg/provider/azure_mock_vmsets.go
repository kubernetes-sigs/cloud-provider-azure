...
//
//	mockgen -destination=./azure_mock_vmsets.go -source=./azure_vmsets.go -package=provider VMSet
//
...
func (m *MockVMSet) EnsureBackendPoolDeleted(ctx context.Context, service *v1.Service, backendPoolIDs []string, vmSetName string, backendAddressPools []*armnetwork.BackendAddressPool, deleteFromVMSet bool) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockVMSet) GetPrimaryInterface(ctx context.Context, nodeName string) (*armnetwork.Interface, error) {
	m.ctrl.T.Helper()
