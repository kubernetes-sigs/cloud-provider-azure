...
// Source: /home/azureuser/go/src/sigs.k8s.io/cloud-provider-azure/pkg/provider/azure_vmsets.go
//
// Generated by this command:
//
//	mockgen -copyright_file=/home/azureuser/go/src/sigs.k8s.io/cloud-provider-azure/hack/boilerplate/boilerplate.generatego.txt -destination=/home/azureuser/go/src/sigs.k8s.io/cloud-provider-azure/pkg/provider/azure_mock_vmsets.go -source=/home/azureuser/go/src/sigs.k8s.io/cloud-provider-azure/pkg/provider/azure_vmsets.go -package=provider VMSet
//
...
func (m *MockVMSet) EnsureHostInPool(ctx context.Context, service *v1.Service, nodeName types.NodeName, backendPoolID, vmSetName string) (string, string, string, *vmssvmclient.VirtualMachineScaleSetVM, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureHostInPool", ctx, service, nodeName, backendPoolID, vmSetName)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(string)
	ret3, _ := ret[3].(*vmssvmclient.VirtualMachineScaleSetVM)
	ret4, _ := ret[4].(error)
