...
//
//	mockgen -package provider -source azure_loadbalancer_backendpool.go -self_package sigs.k8s.io/cloud-provider-azure/pkg/provider -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt BackendPool
//
...
func (mr *MockBackendPoolMockRecorder) CleanupVMSetFromBackendPoolByCondition(slb, service, nodes, clusterName, shouldRemoveVMSetFromSLB any) *gomock.Call {
...
func (mr *MockBackendPoolMockRecorder) GetBackendPrivateIPs(clusterName, service, lb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendPoolMockRecorder) ReconcileBackendPools(clusterName, service, lb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
