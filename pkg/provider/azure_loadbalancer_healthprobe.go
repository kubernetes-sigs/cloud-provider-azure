...
func (az *Cloud) buildHealthProbeRulesForPort(
	serviceManifest *v1.Service,
	port v1.ServicePort,
	lbrule string,
	healthCheckNodePortProbe *armnetwork.Probe,
	useSharedProbe bool,
	...
	*protocol = strings.TrimSpace(*protocol)
	...
	// Select request path
	if *properties.Protocol == armnetwork.ProbeProtocolHTTPS || *properties.Protocol == armnetwork.ProbeProtocolHTTP {
...
func findProbe(probes []*armnetwork.Probe, probe *armnetwork.Probe) bool {
	for _, existingProbe := range probes {
		...
		if strings.EqualFold(ptr.Deref(existingProbe.Name, ""), ptr.Deref(probe.Name, "")) &&
			...
			existingProbe.Properties.Protocol == probe.Properties.Protocol &&
