...
func TestReconcileLoadBalancerRule(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			probeProtocol:   "Https",
			probePath:       "/healthy1",
			expectedProbes:  getTestProbes("Https", "/healthy1", pointer.Int32(20), pointer.Int32(10080), pointer.Int32(5)),
			expectedRules:   getDefaultTestRules(true),
		},
		{
			...
			loadBalancerSku: "standard",
			probeProtocol:   "Http",
			expectedProbes:  getTestProbes("Tcp", "", pointer.Int32(20), pointer.Int32(10080), pointer.Int32(5)),
			expectedRules:   getDefaultTestRules(true),
		},
		{
	...
	testCases = append(testCases, struct {
		...
		loadBalancerSku: "standard",
		probeProtocol:   "Tcp",
		expectedProbes:  getTestProbes("Tcp", "", pointer.Int32(10), pointer.Int32(10080), pointer.Int32(10)),
		expectedRules:   rules,
	})
	...
	probes := getTestProbes("Http", "/healthz", pointer.Int32(5), pointer.Int32(34567), pointer.Int32(2))
	probes[0].Name = pointer.String("atest1-TCP-34567")
	testCases = append(testCases, struct {
		desc            string
		service         v1.Service
		loadBalancerSku string
...
func getTestProbe(protocol, path string, interval, port, numOfProbe *int32) network.Probe {
	expectedProbes := network.Probe{
		Name: pointer.String(fmt.Sprintf("atest1-TCP-%d", *port-10000)),
		ProbePropertiesFormat: &network.ProbePropertiesFormat{
...
func getDefaultTestProbes(protocol, path string) []network.Probe {
	return getTestProbes(protocol, path, pointer.Int32(5), pointer.Int32(10080), pointer.Int32(2))
}
