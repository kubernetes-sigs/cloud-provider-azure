			...
			existingPIPs: []network.PublicIPAddress{
				{
					...
					Tags: map[string]*string{
						...
						consts.LegacyServiceTagKey: pointer.String("foo"), // It should be ignored when ServiceTagKey is present.
					},
					PublicIPAddressPropertiesFormat: &network.PublicIPAddressPropertiesFormat{
						PublicIPAddressVersion: network.IPv4,
						IPAddress:              pointer.String("1.2.3.4"),
...
func TestUnbindServiceFromPIP(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			InputTags: map[string]*string{
				consts.ServiceTagKey: pointer.String("ns1/svc1,ns2/svc2"),
			},
			ExpectedTags: map[string]*string{
				consts.ServiceTagKey: pointer.String("ns1/svc1"),
			},
		...
		},
		{
			...
			ExpectedTags: map[string]*string{
				consts.ServiceTagKey: pointer.String("ns1/svc1,ns3/svc3"),
			},
			...
			existingLBs: []network.LoadBalancer{
				{
					...
					LoadBalancerPropertiesFormat: &network.LoadBalancerPropertiesFormat{
						BackendAddressPools: &[]network.BackendAddressPool{
							{
								Name: pointer.StringPtr("kubernetes"),
								BackendAddressPoolPropertiesFormat: &network.BackendAddressPoolPropertiesFormat{
									LoadBalancerBackendAddresses: &[]network.LoadBalancerBackendAddress{
										{
											Name: pointer.StringPtr("node2"),
											LoadBalancerBackendAddressPropertiesFormat: &network.LoadBalancerBackendAddressPropertiesFormat{
												IPAddress: pointer.StringPtr("10.1.0.2"),
											},
										},
									},
								},
									...
									LoadBalancerBackendAddresses: &[]network.LoadBalancerBackendAddress{
										{
											...
											LoadBalancerBackendAddressPropertiesFormat: &network.LoadBalancerBackendAddressPropertiesFormat{
												IPAddress: pointer.StringPtr("10.1.0.3"),
											},
										},
										{
											Name: pointer.StringPtr("node4"),
											LoadBalancerBackendAddressPropertiesFormat: &network.LoadBalancerBackendAddressPropertiesFormat{
												IPAddress: pointer.StringPtr("10.1.0.4"),
											},
										},
										{
											Name: pointer.StringPtr("node5"),
											LoadBalancerBackendAddressPropertiesFormat: &network.LoadBalancerBackendAddressPropertiesFormat{
												IPAddress: pointer.StringPtr("10.1.0.5"),
											},
										},
									},
								},
