...
// IsK8sServiceUsingInternalLoadBalancer return if floating IP in load balancer is disabled in kubernetes service annotations
...
=======
>>>>>>> parent of dbf5be0df (use nodePort for backendPort and disable floating IP when using IPv6 services)
