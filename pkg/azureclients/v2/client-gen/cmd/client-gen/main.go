...
import (
	...
	"sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/client-gen/generator"
)
...
func main() {
	...
	cmd := &cobra.Command{
		Use:   "client-gen",
		Short: "Generate azure client code.",
		Long:  "Generate azure client code.",
		Example: `	# Generate azure client code for all interfaces under azureclients/v2/,
	# outputting clients to /tmp/clientset and everything else to stdout
	client-gen clientgen output:clientgen:dir=/tmp/clientset output:stdout
`,
	...
	if err := cmd.Execute(); err != nil {
		if errors.As(err, &noUsageError{}) && err != nil {
