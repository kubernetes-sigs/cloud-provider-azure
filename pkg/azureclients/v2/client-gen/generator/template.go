...
func (client *Client) Get(ctx context.Context, resourceGroupName string, resourceName string, expand *string) (result *{{.PackageAlias}}.{{.Resource}}, rerr error) {
	var ops *network.{{.ClientName}}GetOptions
	if expand != nil {
		ops = &network.{{.ClientName}}GetOptions{Expand: expand}
	}
