...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/securitygroupclient (interfaces: Interface)

// Package securitygroupclient_test is a generated GoMock package.
package securitygroupclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.SecurityGroup) (*armnetwork.SecurityGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armnetwork.SecurityGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.SecurityGroup, error) {
	m.ctrl.T.Helper()
