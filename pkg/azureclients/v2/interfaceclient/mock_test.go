...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/interfaceclient (interfaces: Interface)

// Package interfaceclient_test is a generated GoMock package.
package interfaceclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.Interface) (*armnetwork.Interface, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.Interface, error) {
	m.ctrl.T.Helper()
