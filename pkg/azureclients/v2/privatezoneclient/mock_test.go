...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/privatezoneclient (interfaces: Interface)

// Package privatezoneclient_test is a generated GoMock package.
package privatezoneclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armprivatedns.PrivateZone) (*armprivatedns.PrivateZone, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armprivatedns.PrivateZone, error) {
	m.ctrl.T.Helper()
