...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/publicipaddressclient (interfaces: Interface)

// Package publicipaddressclient_test is a generated GoMock package.
package publicipaddressclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.PublicIPAddress) (*armnetwork.PublicIPAddress, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.PublicIPAddress, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.PublicIPAddress, error) {
	m.ctrl.T.Helper()
