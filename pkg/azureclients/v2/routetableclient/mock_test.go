...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/routetableclient (interfaces: Interface)

// Package routetableclient_test is a generated GoMock package.
package routetableclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.RouteTable) (*armnetwork.RouteTable, error) {
	m.ctrl.T.Helper()
