...
// +azure:client:verbs=get;createorupdate;delete;list,resource=PrivateLinkService,packageName=github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/network/armnetwork/v2,packageAlias=network,clientName=PrivateLinkServicesClient,apiVersion="2021-08-01"
type Interface interface {
	utils.GetFunc[network.PrivateLinkService]
