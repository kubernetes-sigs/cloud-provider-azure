...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/privatelinkserviceclient (interfaces: Interface)

// Package privatelinkserviceclient_test is a generated GoMock package.
package privatelinkserviceclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.PrivateLinkService) (*armnetwork.PrivateLinkService, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.PrivateLinkService, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.PrivateLinkService, error) {
	m.ctrl.T.Helper()
