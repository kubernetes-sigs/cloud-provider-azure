...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/diskclient (interfaces: Interface)

// Package diskclient_test is a generated GoMock package.
package diskclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armcompute.Disk) (*armcompute.Disk, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armcompute.Disk, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armcompute.Disk, error) {
	m.ctrl.T.Helper()
