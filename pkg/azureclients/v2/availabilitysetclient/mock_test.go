...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/availabilitysetclient (interfaces: Interface)

// Package availabilitysetclient_test is a generated GoMock package.
package availabilitysetclient_test
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armcompute.AvailabilitySet, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armcompute.AvailabilitySet, error) {
	m.ctrl.T.Helper()
