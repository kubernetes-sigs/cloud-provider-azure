...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/privateendpointclient (interfaces: Interface)

// Package privateendpointclient_test is a generated GoMock package.
package privateendpointclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.PrivateEndpoint) (*armnetwork.PrivateEndpoint, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.PrivateEndpoint, error) {
	m.ctrl.T.Helper()
