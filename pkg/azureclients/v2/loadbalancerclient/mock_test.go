...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/loadbalancerclient (interfaces: Interface)

// Package loadbalancerclient_test is a generated GoMock package.
package loadbalancerclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.LoadBalancer) (*armnetwork.LoadBalancer, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.LoadBalancer, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.LoadBalancer, error) {
	m.ctrl.T.Helper()
