...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/virtualmachineclient (interfaces: Interface)

// Package virtualmachineclient_test is a generated GoMock package.
package virtualmachineclient_test
