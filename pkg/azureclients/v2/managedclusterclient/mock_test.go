...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azureclients/v2/managedclusterclient (interfaces: Interface)

// Package managedclusterclient_test is a generated GoMock package.
package managedclusterclient_test
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armcontainerservice.ManagedCluster) (*armcontainerservice.ManagedCluster, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armcontainerservice.ManagedCluster, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armcontainerservice.ManagedCluster, error) {
	m.ctrl.T.Helper()
