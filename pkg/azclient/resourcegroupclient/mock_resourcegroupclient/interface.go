...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/resourcegroupclient (interfaces: Interface)
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1 string, arg2 armresources.ResourceGroup) (*armresources.ResourceGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1 string) (*armresources.ResourceGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context) ([]*armresources.ResourceGroup, error) {
	m.ctrl.T.Helper()
