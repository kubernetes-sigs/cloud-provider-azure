...
//
//	mockgen -package mock_sshpublickeyresourceclient -source sshpublickeyresourceclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
