...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/publicipprefixclient (interfaces: Interface)
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armnetwork.PublicIPPrefix) (*armnetwork.PublicIPPrefix, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.PublicIPPrefix, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.PublicIPPrefix, error) {
	m.ctrl.T.Helper()
