...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/snapshotclient (interfaces: Interface)
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armcompute.Snapshot) (*armcompute.Snapshot, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armcompute.Snapshot, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armcompute.Snapshot, error) {
	m.ctrl.T.Helper()
