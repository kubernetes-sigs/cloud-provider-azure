...
//
//	mockgen -package mock_fileservicepropertiesclient -source fileservicepropertiesclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
