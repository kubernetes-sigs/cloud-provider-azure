...
//
//	mockgen -package mock_privatednszonegroupclient -source privatednszonegroupclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
