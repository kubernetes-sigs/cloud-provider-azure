...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/vaultclient (interfaces: Interface)
...
func (m *MockInterface) CreateOrUpdate(arg0 context.Context, arg1, arg2 string, arg3 armkeyvault.VaultCreateOrUpdateParameters) (*armkeyvault.Vault, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armkeyvault.Vault, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armkeyvault.Vault, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) PurgeDeleted(arg0 context.Context, arg1, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PurgeDeleted", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// PurgeDeleted indicates an expected call of PurgeDeleted.
func (mr *MockInterfaceMockRecorder) PurgeDeleted(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PurgeDeleted", reflect.TypeOf((*MockInterface)(nil).PurgeDeleted), arg0, arg1, arg2)
}
