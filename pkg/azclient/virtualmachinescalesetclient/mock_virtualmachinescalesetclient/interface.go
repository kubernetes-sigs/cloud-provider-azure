...
//
//	mockgen -package mock_virtualmachinescalesetclient -source virtualmachinescalesetclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
