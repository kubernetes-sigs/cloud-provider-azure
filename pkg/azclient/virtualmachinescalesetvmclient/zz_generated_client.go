...
func (client *Client) Get(ctx context.Context, resourceGroupName string, parentResourceName string, resourceName string) (result *armcompute.VirtualMachineScaleSetVM, rerr error) {
	var ops *armcompute.VirtualMachineScaleSetVMsClientGetOptions

	resp, err := client.VirtualMachineScaleSetVMsClient.Get(ctx, resourceGroupName, parentResourceName, resourceName, ops)
	if err != nil {
		return nil, err
	}
	//handle statuscode
