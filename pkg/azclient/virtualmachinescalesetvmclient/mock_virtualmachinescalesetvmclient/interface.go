...
//
//	mockgen -package mock_virtualmachinescalesetvmclient -source virtualmachinescalesetvmclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
