...
//
//	mockgen -package mock_loadbalancerclient -source loadbalancerclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
...
func (mr *MockInterfaceMockRecorder) MigrateToIPBased(ctx, groupName, loadBalancerName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MigrateToIPBased", reflect.TypeOf((*MockInterface)(nil).MigrateToIPBased), ctx, groupName, loadBalancerName, options)
}
