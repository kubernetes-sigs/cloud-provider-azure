...
//
//	mockgen -package mock_virtualnetworkclient -source virtualnetworkclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
...
func (mr *MockInterfaceMockRecorder) CheckIPAddressAvailability(ctx, resourceGroupName, virtualNetworkName, ipAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckIPAddressAvailability", reflect.TypeOf((*MockInterface)(nil).CheckIPAddressAvailability), ctx, resourceGroupName, virtualNetworkName, ipAddress)
}
