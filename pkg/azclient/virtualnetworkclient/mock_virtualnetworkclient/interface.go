...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/virtualnetworkclient (interfaces: Interface)
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string, arg3 *string) (*armnetwork.VirtualNetwork, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 context.Context, arg1 string) ([]*armnetwork.VirtualNetwork, error) {
	m.ctrl.T.Helper()
