...
//
//	mockgen -package mock_blobcontainerclient -source blobcontainerclient/interface.go -copyright_file ../../hack/boilerplate/boilerplate.generatego.txt
//
...
func (mr *MockInterfaceMockRecorder) CreateContainer(ctx, resourceGroupName, accountName, containerName, parameters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateContainer", reflect.TypeOf((*MockInterface)(nil).CreateContainer), ctx, resourceGroupName, accountName, containerName, parameters)
}
...
func (mr *MockInterfaceMockRecorder) DeleteContainer(ctx, resourceGroupName, accountName, containerName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
