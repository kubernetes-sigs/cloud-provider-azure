...
// Source: sigs.k8s.io/cloud-provider-azure/pkg/azclient/registryclient (interfaces: Interface)
...
func (m *MockInterface) Create(arg0 context.Context, arg1, arg2 string, arg3 armcontainerregistry.Registry) (*armcontainerregistry.Registry, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(arg0 context.Context, arg1, arg2 string) (*armcontainerregistry.Registry, error) {
	m.ctrl.T.Helper()
