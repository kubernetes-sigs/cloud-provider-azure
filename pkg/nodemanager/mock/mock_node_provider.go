...
// GetMetadataLabels mocks base method.
func (m *MockNodeProvider) GetMetadataLabels(ctx context.Context) (map[string]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMetadataLabels", ctx)
	ret0, _ := ret[0].(map[string]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetMetadataLabels indicates an expected call of GetMetadataLabels.
func (mr *MockNodeProviderMockRecorder) GetMetadataLabels(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMetadataLabels", reflect.TypeOf((*MockNodeProvider)(nil).GetMetadataLabels), ctx)
}
