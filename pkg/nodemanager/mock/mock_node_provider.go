...
// GetInterconnectGroupID mocks base method.
func (m *MockNodeProvider) GetInterconnectGroupID(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetInterconnectGroupID", ctx)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetInterconnectGroupID indicates an expected call of GetInterconnectGroupID.
func (mr *MockNodeProviderMockRecorder) GetInterconnectGroupID(ctx any) *gomock.Call {
