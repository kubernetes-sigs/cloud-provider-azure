...
| `cloudControllerManager.controllers`                              | `"*,-cloud-node"`                    | comma-separated list of controllers to enable/disable, e.g. `"*,-cloud-node,-service-lb-controller"` to also disable the service-lb-controller                                  |
