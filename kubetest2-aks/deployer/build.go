...
func (d *deployer) makeCloudProviderImagesByPath() (string, error) {
	logger := log.Background().WithName("makeCloudProviderImagesByPath")
...
func (d *deployer) makeCloudProviderImagesByTag(url string) (string, error) {
	logger := log.Background().WithName("makeCloudProviderImagesByTag")
...
func (d *deployer) Build() error {
	logger := log.Background().WithName("Build")
