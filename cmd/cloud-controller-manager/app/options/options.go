...
import (
	...
	ccmconfig "k8s.io/cloud-provider-azure/cmd/cloud-controller-manager/app/apis/config"
	ccmconfigscheme "k8s.io/cloud-provider-azure/cmd/cloud-controller-manager/app/apis/config/scheme"
	ccmconfigv1alpha1 "k8s.io/cloud-provider-azure/cmd/cloud-controller-manager/app/apis/config/v1alpha1"
