...
FROM --platform=linux/amd64 mcr.microsoft.com/oss/go/microsoft/golang:1.24.2-1-bookworm@sha256:1bdcf4a46716b0a27fc6e9ec57cdfe585ccb0201aed9965cdf4e7ecfce5fea85 AS builder
