...
| `service.beta.kubernetes.io/azure-pip-prefix-name` | ID of Public IP Prefix | Specify the Public IP Prefix that will be applied to load balancer. It takes `service.beta.kubernetes.io/azure-pip-name` as the name when creating PIP. | v1.21 and later with out-of-tree cloud provider |
