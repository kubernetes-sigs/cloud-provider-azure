...
linkTitle: v1.35.3
date: 2026-04-01
description: Cloud Provider Azure v1.35.3
---
Full Changelog: [v1.35.2..v1.35.3](https://github.com/kubernetes-sigs/cloud-provider-azure/compare/v1.35.2...v1.35.3)
...
- The build system now auto-detects and supports podman as the container CLI. When podman is available it is used for image build, push, and manifest operations. Set CONTAINER_CLI=docker to force docker usage. ([#10112](https://github.com/kubernetes-sigs/cloud-provider-azure/pull/10112), [@nilo19](https://github.com/nilo19))
